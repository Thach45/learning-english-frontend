...
import { useCreatePost, useCommunityFeed, useListFollowers, useListFollowing } from '../hooks/useCommunity';
...
const UserProgressDashboard: React.FC = () => {
  ...
  const { studySets: myStudySets } = useStudySets({ initialParams: { page: 1, pageSize: 5 } });
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {feedItems
          ...
          <div className="lg:col-span-4">
            <FriendsListSidebar
              friends={followingData ?? { items: [], total: 0, page: 1, pageSize: 20 }}

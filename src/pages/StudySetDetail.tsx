...
import { ArrowLeft, Play, Brain, BookOpen, Edit, Share2, Users, Calendar, Globe, Lock, Star, X, Lightbulb, BookOpen as BookOpenIcon, PlusCircle } from 'lucide-react';
...
const StudySetDetail: React.FC = () => {
  ...
  const handleAutoFillVocabulary = async () => {
    ...
    try {
      ...
      alert('Không lấy được gợi ý tự động!');
    }
  };
...
// Component con cho form thêm từ vựng
...
const AddVocabularyForm: React.FC<AddVocabularyFormProps> = ({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Nếu có nhiều loại từ, hiển thị rõ từng loại và cho chọn */}
      {partOfSpeechOptions.length > 1 && (
        <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 shadow-sm mb-2">
          ...
          {/* Hiển thị định nghĩa riêng cho loại từ đã chọn */}
          <div className="mt-2">
